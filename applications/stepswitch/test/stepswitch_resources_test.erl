...
invite_parameters_test_() ->
    ...
    _Gateway1 = stepswitch_resources:gateway_from_jobj(GatewayJObj1, Resource),
    ...
    Result4 = stepswitch_resources:sip_invite_parameters(Gateway2, Offnet3),
    Result5 = stepswitch_resources:sip_invite_parameters(Gateway3, Offnet3),     
    ...
    ,?_assertEqual([<<"npid">>, <<"somethingelse&127.0.0.1">>], Result5)
    ]. 
